    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (mission != null) {
            ...
            if (mission.getMisStatus() == Mission.MissionStatus.MISSING
                    ...
                    || mission.getMisStatus() == Mission.MissionStatus.COMPLETED || mission.getMisStatus() == Mission.MissionStatus.REJECTED || mission.getMisStatus() == Mission.MissionStatus.ON_GOING || mission.getMisStatus() == Mission.MissionStatus.SUBMITTED_LATE || mission.getMisStatus() == Mission.MissionStatus.RESUBMITTED) {
                request.setAttribute("errorMessage", "Cannot delete the task that has expired or on going!");
