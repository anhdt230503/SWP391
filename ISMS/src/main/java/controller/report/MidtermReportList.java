...
public class MidtermReportList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Intern> listOfMidtermReport2;
        List<Integer> totalmission = new ArrayList<>();
        ...
        listOfMidtermReport2 = finalReportDAO.getStudentAll();
        ...
        if (role == 4) {
            ...
            for(Intern intern : listOfMidtermReport2 ){
                int it = intern.getInternId();
                totalmission = finalReportDAO.getTotalMissions(it);
                totalfinished = finalReportDAO.getTotalFinished(it);
            }
            request.setAttribute("listOfMidtermReport", listOfMidtermReport);
            request.setAttribute("totalmission", totalmission);
            request.setAttribute("totalfinished", totalfinished);
