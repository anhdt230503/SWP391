 ...
 * @author duong
 */
public class DetailMidterm extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DetailMidterm</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DetailMidterm at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
...
//        response.getWriter().print(reports); 
        ...
        request.getRequestDispatcher("/DetailMidterm.jsp").forward(request, response);
    } 
