...
public class AddScheduleServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int misId = Integer.parseInt(request.getParameter("missionId"));
        ...
        scheduleMission.setInternId(internId);
        scheduleMission.setMisId(misId);
        scheduleMission.setStartDate(java.sql.Date.valueOf(startDate));
        scheduleMission.setHour(hours);
        scheduleMission.setNote(note);
        scheduleMissionDao.addScheduleMission(scheduleMission);
