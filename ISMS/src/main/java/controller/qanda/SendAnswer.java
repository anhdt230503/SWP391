...
public class SendAnswer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SendAnswer</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SendAnswer at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //response.getWriter().print(intern);
        request.getRequestDispatcher("SendAnswer.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        QandADAO qandaDAO = new QandADAO();
        String id = request.getParameter("qandaId");
        int qandId = Integer.parseInt(id);
        QandA qanda = qandaDAO.getQuestionByQuestionId(qandId);
        String answer_text = request.getParameter("answer_text");
        qandaDAO.sendAnswer(qandId, answer_text);
