...
public class NoteDAO extends MyDAO {
    ...
    public List<Note> getAllnote() {
        ...
        String xSql = "select i.note_id, i.intern_id, i.note_content, i.created_at, i.note_title , it.full_name AS internFullName from internnotes i left join intern it on i.intern_id = it.intern_id;";
        try {
            ...
            while (rs.next()) {
                ...
                Note note = new Note(note_id, intern_id, note_title, note_content, createdAt, internFullName);
                notes.add(note);
            }
