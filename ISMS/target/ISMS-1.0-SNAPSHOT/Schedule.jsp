    ...
    <body>
        <jsp:include page="Sidebar.jsp"></jsp:include>
            ...
            <div class="popup" id="popup">
                ...
                <div>
                    <button class="btn btn-primary" onclick="window.location.href = 'ScheduleList'">Cancel</button>
                    <button class="btn btn-primary"onclick="window.location.href = 'ScheduleList'">Ok</button>
                </div>
            </div>
        </div>
